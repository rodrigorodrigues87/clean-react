...
describe('RemoteLoadSurveyList', () => {
  ...
  test('Should throw AccessDeniedError HttpGetClient returns 403', async () => {
  ...
  test('Should throw UnexpectedError HttpGetClient returns 404', async () => {
    const { sut, httpGetClientSpy } = makeSut()
    httpGetClientSpy.response = {
  ...
  test('Should throw UnexpectedError HttpGetClient returns 500', async () => {
    const { sut, httpGetClientSpy } = makeSut()
    httpGetClientSpy.response = {
